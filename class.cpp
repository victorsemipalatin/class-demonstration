...
/**
 *  @brief   Родительский класс
 *  Класс для демонстрации свойства полиморфизма с использованием виртуальной функции
 */
class Parent_2{
  public:
    Parent_2(int x){
...
int main(){
  cout << "Данная программа демонстрирует возможности классов в с++" << endl;
  ...
  // 2.2) демонстрация свойства полиморфизма с использованием виртуальной функции
  Parent_2 p_2(0);
  Child_2 ch_2(0);
